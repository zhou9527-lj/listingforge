...
0. **当前状态速览（2026-08-09 第二十四次）**：正式 Release `v0.1.4` 已发布并验证（构建 run `31320890507` 三端 success，发布页 `https://github.com/zhou9527-lj/listingforge/releases/tag/v0.1.4`，三条安装包下载链接匿名实测 HTTP 200，artifact ID / 大小 / SHA-256 已写入发布方案第七节）。待人工推进：真 Key 三供应商联网验收（余额/费用列才出真实数字）、SignPath Foundation 申请、macOS 公证。
