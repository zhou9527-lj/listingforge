...
0. **当前状态速览（2026-08-10 第二十七次）**：正式 Release `v0.1.5`（任务中心排版修复版）已发布并验证（run `31326806604` 三端 success，三条下载链接 HTTP 200，记录见第二十六次与发布方案）。正式 Release `v0.1.4` 已发布（见第二十四次）。待人工推进：真 Key 三供应商联网验收（余额/费用列才出真实数字）、SignPath Foundation 申请、macOS 公证。
